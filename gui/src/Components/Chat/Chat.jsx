...
const Chat = () => {
    return (
        <div className='chat'>
            ...
            <div
                className="search-messages flex gap-[15px] items-center mx-[10px] p-[10px] rounded-3xl bg-gray-300 dark:bg-[#434343]">
                <SearchOutlinedIcon className='text-dark dark:text-white'
