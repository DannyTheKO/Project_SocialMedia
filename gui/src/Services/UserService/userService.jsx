...
export const updateEmployee = (userID, userInfo) => axios.put(REST_API_BASE_URL + "/user/" + userID + "/update", userInfo);

export const deleteEmployee = (userID) => axios.delete(REST_API_BASE_URL + "/user/" + userID + "/delete");