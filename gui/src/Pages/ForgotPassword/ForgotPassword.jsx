...
const ForgotPassword = () => {
    return (
        <div className='h-screen bg-black flex items-center justify-center'>
            <div className="w-1/2 min-h-[400px] flex flex-col items-center pt-[40px] bg-white rounded-[10px] overflow-hidden">
                ...
                <div className='w-full'>
                    <form className='flex flex-col justify-center items-center gap-[20px]'>
                        ...
                        />
                        <button className='w-3/4 py-[12px] text-[20px] bg-blue-500 hover:bg-[lightgray] hover:text-[#222] text-white font-bold rounded-xl cursor-pointer'>
                            Xác nhận
                        </button>
                        <Link to="/login">
