        ...
        <div className='friends'>
            <div className='row-1 flex flex-col gap-[15px]'>
                ...
                <div className='flex gap-[10px]'>
                    <button className='bg-gray-300 text-black dark:bg-[#4a4a4a] hover:bg-gray-500 dark:text-white px-4 py-2 rounded-3xl font-medium text-[18px] cursor-pointer'>Gợi ý</button>
                    <button className='bg-gray-300 text-black dark:bg-[#4a4a4a] hover:bg-gray-500 dark:text-white px-4 py-2 rounded-3xl font-medium text-[18px] cursor-pointer'>Bạn bè</button>
                </div>
            </div>
                ...
                <div className='flex gap-[15px] items-center'>
                    ...
                    <div className='user-info flex flex-col gap-[5px] w-1/2 max-2xl:w-3/4'>
                        ...
                        <div className='interact flex gap-[10px]'>
                            <button className='bg-blue-600 hover:bg-gray-200 dark:hover:bg-gray-400 w-3/4 px-6 py-2 text-[22px] font-medium text-white rounded-lg hover:bg- cursor-pointer flex gap-[10px] items-center justify-center'><CheckOutlinedIcon />Chấp nhận</button>
                            <button className='bg-[#4a4a4a]  hover:bg-gray-200 dark:hover:bg-gray-400 w-3/4 px-6 py-2 text-[22px] font-medium text-white rounded-lg cursor-pointer flex gap-[10px] items-center justify-center'><CancelPresentationIcon />Gỡ</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="row-3 flex flex-col gap-[15px]">
                ...
                <div className='flex gap-[15px] items-center'>
                    ...
                    <div className='user-info flex flex-col gap-[15px] w-1/2 max-2xl:w-3/4'>
                        <p className='text-[22px] font-semibold text-black dark:text-white'>Jane Doe</p>
                        <div className='interact flex gap-[10px]'>
                            <button className='bg-blue-600 hover:bg-gray-200 dark:hover:bg-gray-400 w-3/4 px-6 py-2 text-[22px] font-medium text-white rounded-lg hover:bg- cursor-pointer flex gap-[10px] items-center justify-center'> <PersonAddIcon />Thêm bạn bè</button>
                            <button className='bg-[#4a4a4a] hover:bg-gray-200 dark:hover:bg-gray-400 w-3/4 px-6 py-2 text-[22px] font-medium text-white rounded-lg cursor-pointer flex gap-[10px] items-center justify-center'><CancelPresentationIcon />Gỡ</button>
                        </div>
                    </div>
                </div>
